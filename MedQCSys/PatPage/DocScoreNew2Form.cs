...
{
    public partial class DocScoreNew2Form : DockContentBase
    {
        ...
        public DocScoreNew2Form(MainForm parent)
            : base(parent)
        {
        ...
        public DocScoreNew2Form(MainForm parent, PatPage.PatientPageControl patientPageControl)
