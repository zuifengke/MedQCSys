...
namespace EMRDBLib.HerenHis
{
    ...
    public class InpVisit : DbTypeBase
    {
        ...
        /// 院区
        /// </summary>
        public string BRANCH_HOSP { get; set; }
        ...
        /// 有出院31天内再住院计划
        /// </summary>
        public string HAS_ADMISSION_AGAIN_PLAN { get; set; }

        /// <summary>
        /// 入院前颅脑损伤患者昏迷时间（天）
        /// </summary>
        public string COMA_DATE_DAYS_BEFORE { get; set; }

        /// <summary>
        /// 入院前颅脑损伤患者昏迷时间（小时）
        /// </summary>
        public string COMA_DATE_HOURS_BEFORE { get; set; }

        /// <summary>
        /// 入院前颅脑损伤患者昏迷时间（分）
        /// </summary>
        public string COMA_DATE_MINUTES_BEFORE { get; set; }

        /// <summary>
        /// 入院后颅脑损伤患者昏迷时间（天）
        /// </summary>
        public string COMA_DATE_DAYS_AFTER { get; set; }

        /// <summary>
        /// 入院后颅脑损伤患者昏迷时间（小时）
        /// </summary>
        public string COMA_DATE_HOURS_AFTER { get; set; }

        /// <summary>
        /// 入院后颅脑损伤患者昏迷时间（分）
        /// </summary>
        public string COMA_DATE_MINUTES_AFTER { get; set; }

        /// <summary>
        /// 单病种管理
        /// </summary>
        public string SINGLE_DISEASE_MANAGE { get; set; }

        /// <summary>
        /// 临床路径管理
        /// </summary>
        public string CP_MANAGE { get; set; }
        ...
        /// 转入医疗机构名称
        /// </summary>
        public string TO_MEDICAL_INSTITUTION { get; set; }

        /// <summary>
        /// 再入院目的
        /// </summary>
        public string FOR_INPATIENT_PURPOSES { get; set; }

        /// <summary>
        /// 收费方案ID
        /// </summary>
        public string CHARGE_PRICE_SCHEDULE_ID { get; set; }
        ...
        /// 责任护士姓名
        /// </summary>
        public string BY_NURSE_NAME { get; set; }
        ...
        /// 随诊期限
        /// </summary>
        public decimal FOLLOW_INTERVAL { get; set; }
        ...
        /// 是否为本院第一例
        /// </summary>
        public decimal FIRST_CASE_INDICATOR { get; set; }
