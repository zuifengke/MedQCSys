...
namespace Heren.MedQC.QuestionChat
{
    internal partial class LoginForm : HerenForm
    {
        public LoginForm()
        {
            ...
            this.Icon = Heren.MedQC.QuestionChat.Properties.Resources.LoginIcon;
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            brush.Dispose();
            //
            Image img = Heren.MedQC.QuestionChat.Properties.Resources.LoginBgImage;
        ...
        private void btnLogin_Click(object sender, EventArgs e)
        {
            ...
            if (szUserID != "administrator")
            {
                ...
                shRet = QcMsgChatAccess.Instance.GetUserInfo(szUserID, ref userInfo);
            ...
            else
            {
                ...
                userInfo.ID = "administrator";
                userInfo.Name = "管理员";
            }
            //验证用户输入的密码
            shRet = QcMsgChatAccess.Instance.VerifyUser(szUserID, this.txtUserPwd.Text);
            if (shRet != SystemData.ReturnValue.OK)
            {
            ...
            SystemParam.Instance.QChatArgs.PatientID = string.Empty;
            SystemParam.Instance.QChatArgs.VisitID = string.Empty;
            SystemParam.Instance.QChatArgs.Listener = string.Empty;
            SystemParam.Instance.QChatArgs.Sender = userInfo.Name;
