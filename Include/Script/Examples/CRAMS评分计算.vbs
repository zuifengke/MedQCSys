...
Public Overrides Sub Calculate(ByVal szElementName As String)
    ...
    Dim szName1 As String = "CRAMS评分循环"
    Dim szName2 As String = "CRAMS评分呼吸"
    Dim szName3 As String = "CRAMS评分腹部"
    Dim szName4 As String = "CRAMS评分运动"
    Dim szName5 As String = "CRAMS评分语言"
    ...
    Me.SetElementValue("CRAMS评分", result.ToString())
