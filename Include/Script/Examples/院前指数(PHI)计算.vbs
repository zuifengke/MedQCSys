...
Public Overrides Sub Calculate(ByVal szElementName As String)
    ...
    Dim szName1 As String = "院前指数(PHI)收缩压(mmHg)"
    Dim szName2 As String = "院前指数(PHI)脉搏"
    Dim szName3 As String = "院前指数(PHI)呼吸"
    Dim szName4 As String = "院前指数(PHI)意识"
    ...
    Dim result As Integer = nElementValue1 + nElementValue2 + nElementValue3 + nElementValue4
    Me.SetElementValue("院前指数(PHI)", result.ToString())
End Sub
