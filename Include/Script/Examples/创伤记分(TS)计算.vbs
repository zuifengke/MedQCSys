...
Public Overrides Sub Calculate(ByVal szElementName As String)
    ...
    Dim szName1 As String = "创伤记分(TS)呼吸次数"
    Dim szName2 As String = "创伤记分(TS)幅度"
    Dim szName3 As String = "创伤记分(TS)循环sBP"
    Dim szName4 As String = "创伤记分(TS)毛细血管充盈"
    Dim szName5 As String = "创伤记分(TS)意识状态GCS"
    ...
    If szElementName <> szName1 AndAlso szElementName <> szName2 _
        ...
        AndAlso szElementName <> szName5 Then
        Return
    End If
    ...
    Dim result As Integer = nElementValue1 + nElementValue2 + nElementValue3 + nElementValue4 + nElementValue5
    Me.SetElementValue("创伤记分(TS)", result.ToString())
