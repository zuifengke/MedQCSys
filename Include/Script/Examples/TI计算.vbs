...
Public Overrides Sub Calculate(ByVal szElementName As String)
    ...
    Dim szName1 As String = "TI受伤部位"
    Dim szName2 As String = "TI损伤类型"
    Dim szName3 As String = "TI血压"
    Dim szName4 As String = "TI脉搏"
    Dim szName5 As String = "TI呼吸状态"
    Dim szName6 As String = "TI意识状态"
    ...
    Me.SetElementValue("TI", result.ToString())
