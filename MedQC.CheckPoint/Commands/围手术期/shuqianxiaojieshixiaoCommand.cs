...
namespace Heren.MedQC.CheckPoint.Commands.newhis
{
    /// <summary>
    /// 缺陷点：无术前小结
    /// 核查内容：中等以上手术，病程中无术前小结。急诊手术需在术后三天内完成。择期中等以上手术，病程中术前小结的记录时间在手术开始时间之后。。
    /// </summary>
    public class shuqianxiaojieshixiaoCommand : AbstractCommand
    {
        public shuqianxiaojieshixiaoCommand()
        {
            this.m_name = "新军卫-无术前小结";
        }
