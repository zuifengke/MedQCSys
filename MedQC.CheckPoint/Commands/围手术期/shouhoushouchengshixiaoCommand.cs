...
namespace Heren.MedQC.CheckPoint.Commands.newhis
{
    /// <summary>
    /// 缺陷点：缺术后病程记录或记录不规范
    /// 核查内容：中等以上手术，手术结束后当天有病程记录。如手术结束时间在22点以后，可以在手术结束后5个小时内完成手术当日病程记录。全部病程类记录有一即可。
    /// </summary>
    public class shouhoushouchengshixiaoCommand : AbstractCommand
    {
        public shouhoushouchengshixiaoCommand()
        {
            this.m_name = "新军卫-缺术后病程记录或记录不规范";
        }
