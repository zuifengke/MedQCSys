...
namespace Heren.MedQC.CheckPoint.Commands.newhis
{
    ...
    public class junshixunlianshangCommand : AbstractCommand
    {
        ...
        public override bool Execute(object param, object data, out object result)
        {
            ...
            //查询患者军人标志
            string szSQl = string.Format("select a.IDENTITY,a.TRAINING_INJURY,b.CTRVALUE1 from INP_VISIT@link_emr a,BASE_CODE_DICT@link_emr b where b.CODETYPE_NAME = 'IDENTITY_DICT' and b.CODE_NAME = a.IDENTITY and a.PATIENT_ID = '{0}' and a.VISIT_NO = '{1}'"
            ...
            string CTRVALUE1 = ds.Tables[0].Rows[0]["CTRVALUE1"].ToString();//军人标志0-地方 1-军人
            ...
            if (CTRVALUE1 == "0" && !string.IsNullOrEmpty(TRAINING_INJURY))
            {
            ...
            if (CTRVALUE1 == "1" && string.IsNullOrEmpty(TRAINING_INJURY))
            {
