...
{
    /// <summary>
    /// 缺陷内容：无会诊意见或未在发出申请后48小时内完成
    /// 核查方法：从下急会诊医嘱的时间开始计算，48小时内完成会诊记录。会诊医嘱格式为“**** 科*** 主治医师会诊”、“**** 科会诊”
    /// </summary>
    public class huizhenjilushixiaoCommand : AbstractCommand
    {
        public huizhenjilushixiaoCommand()
        {
            this.m_name = "新军卫-无会诊意见或未在发出申请后48小时内完成";
        }
