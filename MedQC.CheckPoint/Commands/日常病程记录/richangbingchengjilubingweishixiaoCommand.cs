...
{
    /// <summary>
    /// 缺陷内容：危重患者未按规定时间记录病程记录者(病危随时记至少每天一次，病重至少每两天一次)
    /// 核查方法：从有病危医嘱当天开始计算，到病危医嘱结束前一天，每天必须最少有一个病程记录,全部病程类记录有一即可。
    /// </summary>
    public class richangbingchengjilubingweishixiaoCommand : AbstractCommand
    {
        public richangbingchengjilubingweishixiaoCommand()
        {
            this.m_name = "新军卫-病危日常病程记录每天写一次";
        }
