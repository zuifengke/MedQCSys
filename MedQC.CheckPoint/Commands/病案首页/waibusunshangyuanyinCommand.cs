...
namespace Heren.MedQC.CheckPoint.Commands.newhis
{
    ...
    public class waibusunshangyuanyinCommand : AbstractCommand
    {
        ...
        public override bool Execute(object param, object data, out object result)
        {
            ...
            string szSQl = string.Format("select b.DIAGNOSIS_CODE,a.DIAG_TYPE,a.DIAG_DESC from DIAGNOSIS@link_emr a,DIAGNOSIS_DICT@link_emr b where a.DIAG_DESC =b.DIAGNOSIS_NAME(+) and a.VISIT_NO ='{1}' and a.PATIENT_ID ='{0}' and a.DIAG_TYPE = 7 "
